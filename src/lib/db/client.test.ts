...
describe('Database Client', () => {
  ...
  describe('Environment Configuration', () => {
    ...
    it('should handle missing environment variables', () => {
      ...
      const missingEnvError = new Error('Missing required environment variable')
  ...
  describe('Database Schema Validation', () => {
    it('should validate table schemas', () => {
      ...
      Object.keys(userStatsSchema).forEach(key => {
        ...
        expect(userStatsSchema[key as keyof typeof userStatsSchema]).toBeDefined()
      })

      Object.keys(gameScoresSchema).forEach(key => {
        expect(typeof key).toBe('string')
        expect(gameScoresSchema[key as keyof typeof gameScoresSchema]).toBeDefined()
      })
    })
  })
})
